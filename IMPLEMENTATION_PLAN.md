...
#### [NEW] [MainActivity.kt](android/app/src/main/kotlin/co/kockatoos/seeonce_app/MainActivity.kt)
...
#### [MODIFY] [Info.plist](ios/Runner/Info.plist)
...
#### [MODIFY] [AppDelegate.swift](ios/Runner/AppDelegate.swift)
...
#### [NEW] [hive_datasource.dart](lib/data/datasources/hive_datasource.dart)
...
#### [NEW] [key_store.dart](lib/crypto/key_store.dart)
...
#### [NEW] [rsa_cipher.dart](lib/crypto/rsa_cipher.dart)
...
#### [NEW] [hybrid_cipher.dart](lib/crypto/hybrid_cipher.dart)
...
#### [NEW] [peer.dart](lib/data/models/peer.dart)
...
#### [NEW] [settings_repository.dart](lib/data/repositories/settings_repository.dart)
...
#### [NEW] [peer_repository.dart](lib/data/repositories/peer_repository.dart)
...
#### [NEW] [pairing_payload.dart](lib/data/models/pairing_payload.dart)
...
#### [NEW] [pairing_code_service.dart](lib/signaling/pairing_code_service.dart)
...
#### [NEW] [ice_candidate_bundler.dart](lib/signaling/ice_candidate_bundler.dart)
...
#### [NEW] [signaling_service.dart](lib/signaling/signaling_service.dart)
...
#### [NEW] [constants.dart](lib/core/constants.dart)
...
#### [NEW] [rtc_manager.dart](lib/rtc/rtc_manager.dart)
...
#### [NEW] [peer_connection_pool.dart](lib/rtc/peer_connection_pool.dart)
...
#### [NEW] [rtc_channel_handler.dart](lib/rtc/rtc_channel_handler.dart)
...
#### [NEW] [image_message.dart](lib/data/models/image_message.dart)
...
#### [NEW] [image_envelope.dart](lib/data/models/image_envelope.dart)
...
#### [NEW] [image_compressor.dart](lib/image_pipeline/image_compressor.dart)
...
#### [NEW] [image_sender.dart](lib/image_pipeline/image_sender.dart)
...
#### [NEW] [conversation_provider.dart](lib/features/conversation/providers/conversation_provider.dart)
...
#### [NEW] [secure_image_widget.dart](lib/widgets/secure_image_widget.dart)
...
#### [NEW] [image_viewer_screen.dart](lib/features/conversation/screens/image_viewer_screen.dart)
...
#### [NEW] [notification_service.dart](lib/notifications/notification_service.dart)
...
#### [NEW] [peers_screen.dart](lib/features/peers/screens/peers_screen.dart)
...
#### [NEW] [peer_tile.dart](lib/widgets/peer_tile.dart)
...
#### [NEW] [pairing_screen.dart](lib/features/pairing/screens/pairing_screen.dart)

Two tabs:
- **"Share My Code"** → `ShowCodeScreen`
- **"Enter Peer Code"** → `ScanCodeScreen`

#### [NEW] [show_code_screen.dart](lib/features/pairing/screens/show_code_screen.dart)
...
#### [NEW] [scan_code_screen.dart](lib/features/pairing/screens/scan_code_screen.dart)
...
#### [NEW] [conversation_screen.dart](lib/features/conversation/screens/conversation_screen.dart)
...
#### [NEW] [settings_screen.dart](lib/features/settings/screens/settings_screen.dart)
...
#### [NEW] [send_image_button.dart](lib/widgets/send_image_button.dart)
...
#### [NEW] [peers_provider.dart](lib/features/peers/providers/peers_provider.dart)
#### [NEW] [pairing_provider.dart](lib/features/pairing/providers/pairing_provider.dart)
#### [NEW] [conversation_provider.dart](lib/features/conversation/providers/conversation_provider.dart)
#### [NEW] [settings_provider.dart](lib/features/settings/providers/settings_provider.dart)
